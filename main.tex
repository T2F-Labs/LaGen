...
% Main Content (Chapters 1-25 + Appendices A-D)
...
\input{content/chapter6/entry.tex}   % Extension Framework Research
\input{content/chapter7/entry.tex}   % Minimal Core & Generic Primitives
\input{content/chapter8/entry.tex}   % AIDE & ADD Concepts
\input{content/chapter9/entry.tex}   % IaE — Intelligence-as-Extension
\input{content/chapter10/entry.tex}  % UFE — User-First Extension
\input{content/chapter11/entry.tex}  % The Grand Stage & The Pit
\input{content/chapter12/entry.tex}  % System Orchestration
\input{content/chapter13/entry.tex}  % Reinforcement Learning & PPO
\input{content/chapter14/entry.tex}  % Function Quest Training & Generation
\input{content/chapter15/entry.tex}  % Agentic Models
\input{content/chapter16/entry.tex}  % Data Architecture
\input{content/chapter17/entry.tex}  % Pool Manager & Resource Management
\input{content/chapter18/entry.tex}  % Human-Computer Interaction Research
\input{content/chapter19/entry.tex}  % AI Orchestration UI Research
\input{content/chapter20/entry.tex}  % Quality Assurance Research
\input{content/chapter21/entry.tex}  % Deployment Architecture Research
\input{content/chapter22/entry.tex}  % Performance Engineering
\input{content/chapter23/entry.tex}  % Results & Evaluation
\input{content/chapter24/entry.tex}  % Discussion & Reflection
\input{content/chapter25/entry.tex}  % Future Work & Conclusion

% ========== APPENDICES ==========
% Research appendices providing reference materials
% Uses unified appendix cover followed by all individual appendices A-D
\input{content/appendices/entry.tex}  % Unified appendices section with cover + all appendices A-D
