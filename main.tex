...
% Uses unified appendix cover followed by all individual appendices
\input{content/appendices/entry.tex}  % Unified appendices section with cover + all appendices A-G
