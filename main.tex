...
\def\UseTemplate{template4}  % Academic research design - Comprehensive document styling
%
% Template Features:
...
% Institution and organization placeholders
\providecommand{\InstitutionPlaceholder}{Your Institution Name}
...
\ifdefined\UseTemplate
    ...
    \ifthenelse{\equal{\UseTemplate}{template4}}{
        ...
        \templateFourCover{\CoverTitle}{\CoverSubtitle}{\CoverYear}{\CoverRecipient}{\CoverPreparer}
    }{}
\else
    \ifdefined\UseCover
        ...
        % Template4 specific placeholders (Academic Research Design)
        % Note: These are removed from here since they need to be global
