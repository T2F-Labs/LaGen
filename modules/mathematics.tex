...
% Load siunitx first, then physics to avoid conflicts
\usepackage{siunitx}
\usepackage{physics}

% Fix siunitx/physics conflict - suppress the warning
...
% Set math font using unicode-math (for XeLaTeX)
% Note: unicode-math must be loaded before other math packages
\usepackage{unicode-math}
\setmathfont{Latin Modern Math}
\typeout{^^J INFO: Using Latin Modern Math for mathematics^^J}
