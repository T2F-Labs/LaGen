...
% Note: csquotes will be loaded after code module to avoid fvextra warning
\usepackage[all]{nowidow}
\usepackage{needspace}

% Font setup with Inter (if available) - DISABLED to use config.tex font settings
...
% Note: Font configuration is now handled in config.tex
\typeout{^^J INFO: Typography module loaded - using fonts from config.tex^^J}
...
% Smart quotes setup - will be configured after csquotes is loaded
% Note: \MakeOuterQuote will be called from config.tex after csquotes loads
