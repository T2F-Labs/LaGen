...
\usepackage{fontspec}   % Advanced font features (for XeTeX/LuaTeX)
...
\newcommand{\singlespacing}{\setstretch{1.0}}
\newcommand{\onehalfspacing}{\setstretch{1.5}}
\newcommand{\doublespacing}{\setstretch{2.0}}
\newcommand{\customspacing}[1]{\setstretch{#1}}

% Text decoration commands
\newcommand{\textul}[1]{\underline{#1}}         % Underlined text
\newcommand{\textst}[1]{\st{#1}}                % Strikethrough text
...
% Font size relative adjustments
...
\microtypesetup{
    ...
    final,                               % Enable microtype even if draft mode
    tracking=true,                       % Font tracking
    kerning=true,                        % Font kerning
    spacing=true,                        % Letter spacing
    factor=1100,                         % Factor for enhanced protrusion
    stretch=15,                          % Font expansion
    shrink=15                            % Font compression
}
