...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'actorBkg':'#e0f2fe', 'actorBorder':'#5B8FF9', 'actorTextColor':'#1f2937', 'actorLineColor':'#5B8FF9', 'signalColor':'#1f2937', 'signalTextColor':'#1f2937', 'labelBoxBkgColor':'#f9fafb', 'labelBoxBorderColor':'#5B8FF9', 'labelTextColor':'#1f2937', 'loopTextColor':'#1f2937', 'noteBorderColor':'#5B8FF9', 'noteBkgColor':'#f0f9ff', 'noteTextColor':'#1f2937', 'activationBorderColor':'#5B8FF9', 'activationBkgColor':'#7BA5FA', 'sequenceNumberColor':'#ffffff'}}}%%
sequenceDiagram
