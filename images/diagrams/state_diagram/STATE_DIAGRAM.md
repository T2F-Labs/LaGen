...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#252526', 'primaryTextColor':'#E8E8F0', 'primaryBorderColor':'#5B8FF9', 'lineColor':'#7BA5FA', 'secondaryColor':'#2D2D30', 'tertiaryColor':'#1E1E1E', 'noteBkgColor':'#2D2D30', 'noteBorderColor':'#5B8FF9', 'noteTextColor':'#E8E8F0'}}}%%
stateDiagram-v2
