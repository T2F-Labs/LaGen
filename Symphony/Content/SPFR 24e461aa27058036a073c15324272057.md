...
2. **Emergency Output Generation**
    ...
    -  manual assembly instruction generation
...
**Impact**: Code delivery without  documentation
...
**Dependency Chain**: ES001 → ES002 → RM001 → OP001
...
- If neither ES002 nor direct ES001→RM001 viable, terminate chain
