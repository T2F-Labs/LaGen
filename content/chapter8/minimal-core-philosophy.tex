...
The minimal core philosophy emerged from analyzing the pain points of existing IDEs. VSCode, despite its extension system, still ships with over 100 built-in features. JetBrains IDEs bundle comprehensive toolchains that many developers never use. This bloat leads to slower startup times, higher memory usage, and reduced flexibility.
