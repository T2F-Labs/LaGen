...
The process spawning system provides comprehensive control over external process creation and management:
...
Extensions configure process spawning through a comprehensive manifest system:

\begin{lstlisting}[language=toml, caption=Process Configuration Example]
...
[processes.language_server.communication]
stdin = true
stdout = true
stderr = "capture"
protocol = "json-rpc"

[processes.language_server.lifecycle]
auto_start = true
restart_on_crash = true
max_restarts = 5
health_check_interval = 30

[processes.build_task]
command = "cargo"
args = ["build", "--release"]
working_directory = "${workspaceRoot}"
shell = false

[processes.build_task.resources]
memory_limit = "1GB"
cpu_priority = "normal"
timeout = 300
\end{lstlisting}
...
\begin{lstlisting}[language=javascript, caption=Protocol Communication Example]
...
Symphony provides comprehensive resource management to ensure external processes don't impact IDE performance:
