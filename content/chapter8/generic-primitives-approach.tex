...
\begin{lstlisting}[language=bash, caption=Language Server Protocol Configuration]
[protocols.custom]
...
\begin{lstlisting}[language=bash, caption=DAP Extension Configuration]
[protocols.custom]
...
\begin{lstlisting}[language=bash, caption=Custom AI Protocol Configuration]
[protocols.custom]
