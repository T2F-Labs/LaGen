...
\subsection*{Real-World Protocol Examples}
\addcontentsline{toc}{subsection}{Real-World Protocol Examples}

To illustrate the power of generic primitives, consider how different protocols can be implemented:

\subsubsection*{Language Server Protocol (LSP)}

An LSP extension using Symphony's primitives:

\begin{lstlisting}[language=toml, caption=LSP Extension Configuration]
[protocols.custom]
