...
\bottomrule
\end{tabular}
\captionof{table}{Wave 1 Human-AI Relationship}
...
\bottomrule
\end{tabular}
\captionof{table}{Wave 1.5 Platform Analysis}
...
\bottomrule
\end{tabular}
\captionof{table}{Symphony's Wave 2 Innovations}
...
\subsubsection{Complete Wave Comparison}
...
\bottomrule
\end{tabular}
\captionof{table}{Complete Wave Evolution Analysis}
\label{tab:complete-wave-evolution}
\end{center}
...
\bottomrule
\end{tabular}
\captionof{table}{Symphony's Wave 2 Advantages}
