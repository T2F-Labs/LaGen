...
\section{5.2 Architecture Decision Records}
\label{sec:architecture-decisions}
\addcontentsline{toc}{section}{5.2 Architecture Decision Records}
...
\subsection*{5.2.1 Microkernel Architecture}
\addcontentsline{toc}{subsection}{5.2.1 Decision 1: Microkernel Architecture}
...
\subsection*{5.2.2 Dual Ensemble Architecture}
\addcontentsline{toc}{subsection}{5.2.2 Decision 2: Dual Ensemble Architecture}
...
\subsection*{5.2.3 Reinforcement Learning for Orchestration}
\addcontentsline{toc}{subsection}{5.2.3 Decision 3: Reinforcement Learning for Orchestration}
...
\subsection*{5.2.4 Process Isolation for Community Extensions}
\addcontentsline{toc}{subsection}{5.2.4 Decision 4: Process Isolation for Community Extensions}
...
\subsection*{5.2.5 Visual Workflow Composition}
\addcontentsline{toc}{subsection}{5.2.5 Decision 5: Visual Workflow Composition}
...
\subsection*{5.2.6 Three-Tier Access Control}
\addcontentsline{toc}{subsection}{5.2.6 Decision 6: Three-Tier Access Control}
...
\subsection*{5.2.7 Artifact Store with Quality Scoring}
\addcontentsline{toc}{subsection}{5.2.7 Decision 7: Artifact Store with Quality Scoring}
