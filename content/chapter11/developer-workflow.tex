...
\begin{description}[leftmargin=3cm,labelwidth=2.5cm]
    ...
    \item[\textbf{carets test}] Complete testing framework with Symphony integration testing
...
\subsection*{Complete Testing Framework}
...
\begin{expandedlist}
    ...
    \item \textbf{Integrated Testing Framework}: Complete testing approach for AI-first environments
