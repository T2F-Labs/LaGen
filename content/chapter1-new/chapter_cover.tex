...
\begin{itemize}[leftmargin=1.2cm, itemsep=0.4cm, label={\textcolor{brandAccent}{$\triangleright$}}]
    \item {\large The challenges of integrating artificial intelligence into current development environments}
    \item {\large Why effective AI integration matters for software development productivity and innovation}
    \item {\large Symphony's approach to building an AI-first development environment}
    \item {\large The objectives and goals of this graduation project}
    \item {\large How Symphony relates to existing development tools and AI-assisted coding platforms}
    \item {\large Key features that enable effective human-AI collaboration in software development}
\end{itemize}
\end{tcolorbox}
