...
Figure 1.1 illustrates the high-level organization of Symphony's architecture. The diagram shows how the system divides responsibilities between a minimal core and various extensions. The core provides foundational services while extensions add specific capabilities. This separation enables both performance and extensibility, addressing the limitations found in traditional development environments.

\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{images/diagrams/use-case.png}
\caption{High-Level Overview of Symphony System showing the relationship between core components and extension ecosystem. The architecture enables AI integration at the foundational level rather than as supplementary features.}
\label{fig:symphony-overview}
\end{figure}
