...
Symphony's extension infrastructure, known as the \textcolor{brandAccent}{Orchestra Kit}, provides a framework for extension development, distribution, and execution. This framework addresses several key challenges in traditional extension systems:
...
\begin{compactlist}
    \item Open development with SDKs and documentation
