...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{images/diagrams/activity_diagram/symphony-system-bootstrap.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{images/diagrams/state_diagram/4_bootstrap_system_initialization.png}
