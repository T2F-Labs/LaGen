...
\begin{itemize}
    ...
    \item \textbf{Minimal Context}: Lightweight interaction without project analysis
...
\begin{itemize}
    ...
    \item \textbf{Quality Assurance}: Combined human judgment and AI analysis for quality validation
