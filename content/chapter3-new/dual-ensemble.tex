...
The PitCore manages five essential infrastructure extensions that handle AI model lifecycle,
workflow execution, institutional memory, resource allocation, and system optimization as shown in ~\ref{fig:3.11a-pit-core}. These components achieve ultra-low latency through in-process execution.

\begin{figure}[H]
\centering
\includegraphics[width=0.91\textwidth]{images/diagrams/class_diagram/seperate_2_the_pit_aide_layer_execution/Cache Eviction Pipeline-2026-02-06-1201701.png}
...
The Pool Manager handles AI model lifecycle with predictive pre-warming and player state management. The DAG Tracker coordinates workflow execution through dependency mapping, topological sorting, and parallel execution support. Both components work together as shown in ~\ref{fig:3.11b-pit-managers} to optimize workflow performance.
