...
The PitCore manages five essential infrastructure extensions that handle AI model lifecycle, workflow execution, institutional memory, resource allocation, and system optimization. These components achieve ultra-low latency through in-process execution.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/diagrams/class_diagram/seperate_2_the_pit_aide_layer_execution/Cache Eviction Pipeline-2026-02-06-1201701.png}
\caption{The Pit Architecture - Core Infrastructure Components}
\label{fig:3.11a-pit-core}
\end{figure}

\textbf{Pool Manager and DAG Tracker}

The Pool Manager handles AI model lifecycle with predictive pre-warming and player state management. The DAG Tracker coordinates workflow execution through dependency mapping, topological sorting, and parallel execution support. Both components work together to optimize workflow performance.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{images/diagrams/class_diagram/seperate_2_the_pit_aide_layer_execution/Screenshot 2026-02-06 141408.png}
\caption{The Pit Architecture - Pool Manager and DAG Tracker}
\label{fig:3.11b-pit-managers}
\end{figure}
