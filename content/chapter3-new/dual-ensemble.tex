...
\addcontentsline{toc}{section}{3.3 Dual Ensemble Architecture}
...
\subsection*{3.3.1 The Pit: In-Process Execution}
...
\subsection*{3.3.2 The Grand Stage: Out-of-Process Execution}
...
\subsection*{3.3.3 Security and Trust Framework}
...
\subsection*{3.3.4 Player Registration System}
...
\subsection*{3.3.5 Execution Strategy Selection}
