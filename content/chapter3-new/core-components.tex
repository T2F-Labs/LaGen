...
\addcontentsline{toc}{section}{3.4 Core System Components}
...
\subsection*{3.2.1 Six Essential Core Components}
...
\subsection*{3.2.2 Domain Core and Orchestration}
...
\subsection*{3.2.3 Intelligence as Extension Principle}
...
\subsection*{3.2.4 Generic Primitives Foundation}
