% ========== CHAPTER 3 COVER: SYSTEM ANALYSIS AND DESIGN ==========
...
\begin{center}
{\fontsize{26}{30}\selectfont\textcolor{brandPrimary}{\textit{System Analysis and Design}}}
\end{center}
...
\begin{itemize}[leftmargin=1.2cm, itemsep=0.4cm, label={\textcolor{brandAccent}{$\triangleright$}}]
    \item {\large Primary use case scenarios demonstrating system functionality and value}
