...
The Domain Core contains three essential components as shown in ~\ref{fig:3.6a-h2a2-domain-components}: OrchestrationEngine for workflow scheduling, WorkflowDefinitions for templates and validation, and ExtensionPolicies for security rules. These define system behavior independent of implementation details.
