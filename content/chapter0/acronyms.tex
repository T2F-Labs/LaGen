...
%  list of all Symphony terminology and standard technical acronyms
...
\lettrine{T}{his } reference guide provides definitions for all acronyms and abbreviations used throughout the Symphony documentation. Terms are organized by category for easy navigation and reference.
...
\vspace{0.5cm}
\begin{center}
\textit{For detailed definitions and context, refer to the  glossary in Appendix A.}
\end{center}
