...
We conducted a evaluation using a controlled experimental design with multiple comparison groups:
...
We measured skill acquisition using a battery of orchestration challenges that test different aspects of learned capabilities:
...
We designed a set of transfer tasks that mirror real-world development scenarios:
...
Maintaining high quality in automatically generated training content requires quality assessment mechanisms.
