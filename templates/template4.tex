...
\newcommand{\templateFourCover}[5]{%
  ...
  % If logo files exist, they will be displayed; otherwise, this section is skipped
  \IfFileExists{university-logo.jpeg}{
    \begin{minipage}[t]{0.45\textwidth}
        \includegraphics[width=0.8\textwidth]{university-logo.jpeg}
    \end{minipage}
    \hfill
    \IfFileExists{college-logo.jpeg}{
      \begin{minipage}[t]{0.45\textwidth}
          \raggedleft
          \includegraphics[width=0.8\textwidth]{college-logo.jpeg}
      \end{minipage}
    }{
      \begin{minipage}[t]{0.45\textwidth}
          \raggedleft
    ...
    % No logos available - skip logo section
    \vspace{2cm}
  }
